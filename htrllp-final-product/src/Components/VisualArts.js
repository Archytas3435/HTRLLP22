    ...
    <div className="visualArts">
      ...
      >
        ...
        <p>
          ...
          men&aposs blindness prevents them from being able to see the danger
          they are approaching. This could be interpreted as an inability to
          recognize the truth of one&aposs situation or the infallibility of
      ...
      <div className="exhibit-2">
        ...
        <p>
          ...
          a young man looking up the woman&aposs dress hidden from below. The
          ...
          world. The woman&aposs husband is equally blind to the woman&aposs
      ...
      <div className="exhibit-3">
        ...
        <p>
          ...
          dependent. Similarly, the man&aposs position as the only figure in the
          painting adds to a sense of isolation, conveying how blindness can
          lead to marginalization. As this work was created during Picasso&aposs
          ...
          one&aposs ability to recognize the truth.
        </p>
      </div>
    </div>
  );
