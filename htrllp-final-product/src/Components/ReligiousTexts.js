...
export default function ReligiousTexts() {
  ...
  return (
    <>
      ...
      />
      <p>
        The Zohar is a central work in Kabbalah, a type of Jewish mysticism. The
        text explores the idea of the limitations of human perception and
        ...
        universe, one must undergo a spiritual transformation to understand the
        mystical realm, ultimately illustrating that while sight can lead to
        observation and knowledge, true understanding may require blindness to
