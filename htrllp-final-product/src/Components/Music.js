    ...
    <div className="music">
      ...
      >
        ...
        <p>
          ...
          real world due to his drug addiction. The repeated line “You {"don't"}{" "}
          know the chances, {"I'm"} so blind!” highlights blindness as a symbol
          for a lack of true perception of a non-drug-altered reality. The
          lyrics also explore the idea of isolation and disorientation as the{" "}
          {"singer's"} drug-induced blindness causes him to “journey to live a
          life that seems to be a lost reality”. The chorus line of “I can see,
          I can see, {"I'm"} going blind” explains that the singer can observe
          the process of losing focus on the real world, but continues down that
          path regardless of the consequences. The blinding power of addiction
          draws the singer towards moral blindness.{" "}
        </p>
      </div>
      <div
      ...
      >
       {iFrameProps("4NRXx6U8ABQ")}
        <p>
          ...
          background of Las Vegas. The lyrics include the repeated phrase “I{" "}
          {"can't"} see clearly when {"you're"}
          ...
          Vegas also contributes to this idea as “Sin City” is known for its
          moral blindness and is often portrayed as a city where one can go to
          rid themselves of their sorrows. However, even in such a city, the
          singer is “just walking by to let you know”, indicating that this
          moral blindness has not fixed the hole in his heart.
        </p>
      </div>
      <div
      ...
      >
        ...
        <p>
          ...
          blind mice who are being chased by a farmer&aposs wife with a carving
          ...
          the idea that they would not be accepted by the royals. The mice&aposs
          blindness indicates their inability to understand the danger that they
          are in, while the farmer&aposs wife (in this case, the Queen) can see
